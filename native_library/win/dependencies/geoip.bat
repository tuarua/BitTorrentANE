...
call "C:\Program Files\7-Zip\7z.exe" e %pathtome%GeoIP.dat.gz -o%pathtome%geoip-api-c\data
...
call "C:\Program Files\7-Zip\7z.exe" e %pathtome%GeoIPASNum.dat.gz -o%pathtome%geoip\build\data
