...
cd ..\
DEL /F /S /Q /A %pathtome%boost_1_60_0.7z

SETX BOOST_ROOT %pathtome%boost_1_60_0 /m
SETX BOOST_LIBRARYDIR %pathtome%boost_1_60_0\stage\lib /m
SETX BOOST_INCLUDEDIR %pathtome%boost_1_60_0\boost /m
